...
for p in ps:
    log("Error rate now: {}".format(p))
    file_name = "../trndt/{}_d{}_p{}_trnsz{}_imgsdr_eval".format(c_type, d, format(p, '.3f'), trnsz)
...
# nohup python gen_trndt_pe.py -c_type 'sur' --d 7 --trnsz 10000000 > logs/gen_trndt_pe_batch_d7_15to11.log &
