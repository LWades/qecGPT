...
if __name__ == '__main__':
    ...
    if save:
        if e_model == 'depolarized':
            path = abspath(dirname(__file__)) + '/net/fkl_made_' + c_type + '_d{}_k{}_seed{}_er{}_{}.pt'.format(d, k,
                                                                                                                seed,
                                                                                                                er, seq)
            if exists(path):
                None
            ...
            path = abspath(dirname(__file__)) + '/net/fkl_made_' + c_type + '_d{}_k{}_seed{}_ising{}_h{}_{}.pt'.format(
                d, k, seed, beta, h, seq)
            if exists(path):
                None
            else:
